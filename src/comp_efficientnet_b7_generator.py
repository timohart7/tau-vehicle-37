...
base_model = base_model = efficientnet.tfkeras.EfficientNetB7(weights='imagenet', input_shape = (300,300,3), include_top = False)
#base_model.summary()
...
model.save('EfficientNetB7_Timo_300x300ep30.h5')
print("Saved")
